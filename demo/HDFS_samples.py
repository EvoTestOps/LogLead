...
df = enhancer.parse_fiplom()
print(f"as Fiplom event id:    {df['e_event_fiplom_id'][row_index]}")
...
df_seqs = seq_enhancer.events("e_event_fiplom_id")
...
sad.item_list_col = "e_event_fiplom_id"
