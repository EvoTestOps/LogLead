...
sad = ad.AnomalyDetection(numeric_cols=numeric_cols)
sad.test_train_split (seq_enhancer.df_seq, test_frac=0.95)
...
sad =  ad.AnomalyDetection(item_list_col="e_event_id")
sad.test_train_split (seq_enhancer.df_seq, test_frac=0.95)
sad.evaluate_all_ads()

#Events + Numeric
sad =  ad.AnomalyDetection(item_list_col="e_event_id", numeric_cols=numeric_cols)
sad.test_train_split (seq_enhancer.df_seq, test_frac=0.95)
sad.evaluate_all_ads()