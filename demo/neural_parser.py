...
# res = sad.predict(df_eve_test)
# #Unsupervised
# #res = sad.train_IsolationForest(df_eve_train,filter_anos=False, contamination=0.1)
# res = sad.train_IsolationForest(df_eve_train,filter_anos=False, contamination="auto")
# res = sad.predict(df_eve_test)
# res = sad.train_LOF(df_eve_train, filter_anos=True, contamination=0.1)
# res = sad.predict(df_eve_test)
# res = sad.train_KMeans(df_eve_train)
